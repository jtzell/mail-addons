...
flectra.define("mail_private", function (require) {
  "use strict";
    ...
    _openComposer: function (options) {
      ...
      this._composer = new ChatterComposer(
        ...
        options.suggested_partners || [],
        {
          ...
          defaultBody:
            old_composer && old_composer.$input && old_composer.$input.val(),
      ...
      this._composer.insertAfter(this.$(".o_chatter_topbar")).then(function () {
        ...
        self
          .$(".oe_compose_post_private")
          .toggleClass("o_active", toggle_post_private);
      });
    },
  ...
  ChatterComposer.include({
    ...
    _preprocessMessage: function () {
      ...
      this._super().then(function (message) {
        ...
        if (self.options.isLog) {
          ...
          self
            ._checkSuggestedPartners(check_suggested_partners)
      ...
      this.trigger_up("discard_record_changes", {
        proceed: function () {
          if (self.options.isLog) {
            ...
            self
              ._checkSuggestedPartners(checkedSuggestedPartners)
    ...
    _getCheckedSuggestedPartners: function () {
      ...
      // Workaround: flectra code works only when all partners are checked intially,
